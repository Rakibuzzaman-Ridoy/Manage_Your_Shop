    	...
    	<form action="<?php echo $_SERVER['PHP_SELF']?>" method="POST" class="offset-2 col-sm-8">
				...
				<div class="form-group">
				 	...
				 	<select name="spend_product_name" required>
				 		<?php 				 			
				 			$join = " right join product on spend_product.spend_product_name = product.product_id;";
			...
			<a href="spend_product_list.php" class="btn-outline-success">Want to view all the spend product? Click here...</a><br>
