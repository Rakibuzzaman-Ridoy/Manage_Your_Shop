			...
			<div class="row">
				...
				<div class="col-sm-9 border-left border-success p-4"><!--Start of right body Row-->
					...
					<div class="jumbotron"><!--start of add spend product-->
						<h1 class="bg-secondary text-center text-light offset-2 col-sm-9">Add New Spend Product!</h1><hr>
						<form action="<?php echo $_SERVER['PHP_SELF']?>" method="POST" class="offset-2 col-sm-9">
							...
							<?php echo "<button class='btn-outline-dark bg-dark offset-4'><a class='text-success' href='spend_product_list.php'>Want to see spend product list? click here...</a></button>";
							?>	
					</div><!--End of add spend product-->
