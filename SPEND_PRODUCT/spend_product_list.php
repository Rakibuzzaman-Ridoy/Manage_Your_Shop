			...
			<div class="row">
				...
				<div class="col-sm-9 border-left border-success p-4"><!--Start of right body Row-->
					<div class=" border-bottom p-3"><!--Start of body Row first portion-->
						<div class="jumbotron"><!--Start of Spend Product List-->
								<h1 class="bg-secondary text-center text-light offset-2 col-sm-8">Spend Product List!</h1><hr>
								<?php
									$limit = "4"; 
									...
									echo "<table border='5' cellpadding='10px' width = '70%' class='offset-1 col-sm-10'>
											<thead>
												<tr>
										...
										echo "<tbody>
												<tr>
													...
													<td class='text-dark text-center '>
														<a href='spend_product_update.php?id=$spend_product_id'class='btn-outline-primary'>Update</a>
								...
								echo "<button class='btn-outline-dark bg-dark offset-3'><a class='text-success' href='spend_product_add.php'>Want to add new spend product? click here...</a></button>";
									?>
						</div><!--end of spend product list-->
