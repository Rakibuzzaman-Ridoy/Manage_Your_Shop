		...
		<div class="container-fluid"><!--body-->
			<div class="row">
				...
				<div class="col-sm-9 border-left border-success p-4"><!--Start of right body Row-->
					...
					<div class="jumbotron"><!--Start of store product list-->
						<h1 class="bg-secondary text-center offset-1 text-light col-sm-9">Store Product List!</h1><hr>
						<?php
							$limit = "4"; 
							...
							echo "<table border='5' cellpadding='10px' width = '70%' class='offset-1 col-sm-9'>
									<thead>
										<tr>
								...
								echo "<tbody>
										<tr>
											...
											<td class='text-dark text-center '>
												<a href='store_product_update.php?id=$store_product_id'class='btn-outline-primary'>Update</a>
											</td>
										</tr>
									</tbody>";
							}
							...
							echo "<button class='btn-outline-dark bg-dark offset-3'><a class='text-success' href='store_product_add.php'>Want to add new store product? click here...</a></button>";
						?>
