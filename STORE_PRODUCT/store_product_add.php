		...
		<div class="container-fluid"><!--body-->
			<div class="row">
				...
				<div class="col-sm-9 border-left border-success p-4"><!--Start of right body Row-->
					...
					<div class="jumbotron"><!--start of add spend product-->
					<h1 class="bg-secondary text-center text-light offset-1 col-sm-9">Add New Store Product!</h1><hr>
					<form action="<?php echo $_SERVER['PHP_SELF']?>" method="POST" class="offset-1 col-sm-8">
						...
						<br>
							<?php echo "<button class='btn-outline-dark bg-dark offset-3'><a class='text-success' href='store_product_list.php'>Want to see store product list? click here...</a></button>";
						?>
					
				</div><!--end of add store product-->
