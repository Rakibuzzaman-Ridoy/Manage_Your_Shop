...
<html lang="en">
  ...
  <body>
		...
		<div class="container-fluid"><!--body-->
			<div class="row">
				...
				<div class="col-sm-9 border-left border-success p-4"><!--Start of right body Row-->
					...
					<div class="jumbotron">
 	 <h1 class="bg-secondary text-center text-light offset-2 col-sm-8">Add New User!</h1>
 	 <hr/>
 	 <form action="<?php echo $_SERVER['PHP_SELF']?>" method="POST" class="offset-1 col-sm-10">
	...
	<br>
			...
			<?php echo "<button class='btn-outline-dark bg-dark offset-4'><a class='text-success' href='user_list.php'>Want to see user list? click here...</a></button>";
			?>
