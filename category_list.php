...
<html lang="en">
  ...
  <body>
    ...
    <div class="jumbotron">
    	<h1 class="bg-secondary text-center text-light offset-3 col-sm-6">Category List!</h1><hr>
    	<?php 
    		...
    		echo "<a href='category_add.php' class='btn-outline-success'>Add Category Page</a>";
    	?>
    	<b class="text-center offset-3">&copy; All Right Reserved by Rakibuzzaman Rid</b>
	</div>
