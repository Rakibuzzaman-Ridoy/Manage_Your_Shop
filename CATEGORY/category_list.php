		...
		<div class="container-fluid"><!--body-->
			<div class="row">
				...
				<div class="col-sm-9 border-left border-success p-4"><!--Start of right body Row-->
					<div class=" border-bottom p-3"><!--Start of category list page-->
						<div class="jumbotron">
									...
									echo "<tbody>
											<tr>
												...
												<td class='text-dark text-center '>
													<a href='category_update.php?id=$id'class='btn-outline-primary'>Update</a>
							...
							echo "<button class='btn-outline-dark bg-dark offset-3'><a class='text-success' href='category_add.php'>Want to add new category? click here...</a></button>";
							?>							
						</div>

					</div><!--End of Category List page-->
