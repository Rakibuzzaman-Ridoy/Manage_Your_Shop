		...
		<div class="container-fluid"><!--body-->
			<div class="row">
				...
				<div class="col-sm-9 border-left border-success p-4"><!--Start of right body Row-->
					<div class="jumbotron"><!--Start of Product List Page-->
						<h1 class="bg-secondary text-center text-light offset-2 col-sm-8">Product List!</h1><hr>
						<?php 
							$limit = "5";
							...
							echo "<table border='5' cellpadding='10px' width = '70%' class='offset-1 col-sm-11'>
									<thead>
										<tr>
								...
								echo "<tbody>
										<tr>
											...
											<td class='text-dark text-center '>
												<a href='product_update.php?id=$product_id'class='btn-outline-primary'>Update</a>
							...
							echo $obj->pagination("product",$join,null,$limit);
								echo "<button class='btn-outline-dark bg-dark offset-4'><a class='text-success' href='product_add.php'>Want to add new product? click here...</a></button>";
							?>
					</div><!--End of Product List Page-->
